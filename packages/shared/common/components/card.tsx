...
export default function Card({ title, icon, path, total }: CardProps) {
  return (
    <div className="hover:opacity-60 min-w-[366px] cursor-pointer h-[200px] bg-white shadow-2xl mx-[45px] mb-[100px] rounded-md p-[20px] flex flex-col justify-between">
